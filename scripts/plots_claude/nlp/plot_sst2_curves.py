...
Run with:
    python -m scripts.plots_claude.nlp.plot_sst2_curves \\
...
from scripts.plots_claude._common import (  # noqa: F401  (episode/epoch helpers kept per task contract)
    RunInfo,
    episode_to_epoch,
    epoch_step_range,
    identify,
...
from scripts.plots_claude._style import (  # noqa: F401  (arm_palette kept per task contract)
    LABEL,
    PALETTE,
    arm_palette,
    make_figure,
