...
%            -output-directory results/plots_claude/method \
%            scripts/plots_claude/method/aees_overview.tex \
%   && gs -o results/plots_claude/method/aees_overview.cropped.pdf \
...
% the thesis directly with \includegraphics{aees_overview}.
...
\begin{document}
\noindent\hspace*{0.2cm}\begin{tikzpicture}[
    font=\sffamily\small,
